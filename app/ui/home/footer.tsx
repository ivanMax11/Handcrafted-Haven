      ...
      <div className="grid lg:grid-cols-4 grid-cols-2  lg-gap-0 gap-4 px-[10vw] py-[3vw]">
        <div>
          ...
          <p className="text-gray-300">
            Supporting arttisans and craftters worldwide in sharing their unique
            creations
          </p>
        </div>
        ...
        <div className="flex flex-col lg:gap-2 gap-4">
          <h3 className="text-gray-100">NewLetters</h3>
          <input
            className="bg-slate-600 border border-solid lg:h-[2.5vw] h-[6vw] border-gray-300 p-1 "
            placeholder="Enter your email"
            type="text"
          />
          <button className="lg:h-[2.5vw] h-[6vw] text-gray-300 bg-blue-700 " type="button">
            Subcribe
          </button>
        </div>
      </div>
